<template>
    ...
    <div class="screen-box" @click="toggleFullScreen">
      <svg v-if="!isFullScreen" t="1717408008762" class="icon" viewBox="0 0 1024 1024" version="1.1"
        ...
        <path
          ...
          :fill="settingStore.showHeaderBar ? '#ffffff' : '#606266'" p-id="9339"></path>
      </svg>
      <svg v-else t="1717408038796" class="icon" viewBox="0 0 1024 1024" version="1.1"
        ...
        <path
          ...
          :fill="settingStore.showHeaderBar ? '#ffffff' : '#606266'" p-id="9806"></path>
      </svg>
    </div>
    <!-- 个人信息 -->
    <div class="user-info">
  ...
  <!-- 主题设置抽屉 -->
  <el-drawer append-to-body modal-class="drawer-wrapper" v-model="drawer" title="主题设置" direction="rtl" :size="290">
        ...
        <div class="wrapper">
          <div class="color-layout-wrapper">
            <h4 :class="{ 'active-bg': currentTheme == 'classicThemeColors' }"
              @click="changeThemeColor('classicThemeColors')">经典主题</h4>
          ...
          <div class="color-layout-wrapper">
            <h4 :class="{ 'active-bg': currentTheme == 'fashionThemeColors' }"
              @click="changeThemeColor('fashionThemeColors')">时尚主题</h4>
            <div class="color-layout">
          ...
          <div class="color-layout-wrapper">
            <h4 :class="{ 'active-bg': currentTheme == 'freshThemeColors' }"
              @click="changeThemeColor('freshThemeColors')">清新主题</h4>
            <div class="color-layout">
          ...
          <div class="color-layout-wrapper">
            <h4 :class="{ 'active-bg': currentTheme == 'coolThemeColors' }"
              @click="changeThemeColor('coolThemeColors')">酷炫主题</h4>
            <div class="color-layout">
          ...
          <div class="current-layout">
            <div class="color-value">当前风格：<span :style="{ color: currentColor }">{{ currentThemeName }}</span> 主题颜色：
            </div>
      ...
      <div class="divider-item">
        ...
        <div class="wrapper">
          ...
          <div class="item">
            ...
            <el-switch v-model="settingStore.showHeaderLogo" :disabled="settingStore.showHeaderBar" />
          </div>
          <div class="item">
...
const {themeColorName, toggleThemeColor, currentTheme, currentColor, currentThemeName} = useThemeColor();

<template>
  <el-dialog v-model="drawerVisible" :destroy-on-close="true" :title="title" width="800px" draggable>
    <div class="form-layout-wrapper">
      <el-form ref="dialogFormRef" :model="dialogForm" :rules="dialogFormRules" label-width="auto" label-position="left"
